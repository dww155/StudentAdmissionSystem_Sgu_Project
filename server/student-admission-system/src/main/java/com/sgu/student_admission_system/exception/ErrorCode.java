...
public enum ErrorCode {
    ...
    VSAT_RESULT_NOT_FOUND("Vsat result not found", 1951, HttpStatus.NOT_FOUND),
    VSAT_RESULT_ALREADY_EXISTS("Vsat result already exists", 1952, HttpStatus.BAD_REQUEST),
    INVALID_DOT_THI("Invalid dot thi", 1953, HttpStatus.BAD_REQUEST),
    INVALID_MA_DOT_THI("Invalid ma dot thi", 1954, HttpStatus.BAD_REQUEST),
    INVALID_NGAY_THI("Invalid ngay thi", 1955, HttpStatus.BAD_REQUEST),
    INVALID_NAM_THI("Invalid nam thi", 1956, HttpStatus.BAD_REQUEST),
    INVALID_MA_MON_THI("Invalid ma mon thi", 1957, HttpStatus.BAD_REQUEST),
    INVALID_TEN_MON_THI("Invalid ten mon thi", 1958, HttpStatus.BAD_REQUEST),
    INVALID_DIEM("Invalid diem", 1959, HttpStatus.BAD_REQUEST),
    INVALID_THANG_DIEM("Invalid thang diem", 1960, HttpStatus.BAD_REQUEST),
    INVALID_MA_DVTCTDL("Invalid ma dvtctdl", 1961, HttpStatus.BAD_REQUEST),
